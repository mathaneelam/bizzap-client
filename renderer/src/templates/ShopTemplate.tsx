...
export default function ShopTemplate({ config }: TemplateProps) {
  return (
    <div className="template-shop">
        ...
        <section className="section-padding text-center" style={{ backgroundColor: '#ffffff' }}>
          <div className="container">
            <div className="section-header">
              <h2>Contact Us & Orders</h2>
              <p>Place an order or send us an inquiry. We will get back to you shortly.</p>
            </div>
