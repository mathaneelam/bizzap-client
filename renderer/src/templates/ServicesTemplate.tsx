...
export default function ServicesTemplate({ config }: TemplateProps) {
  return (
      ...
      <main>
        {config.sections.map((section, idx) => {
          switch (section.type) {
            ...
            case 'catalog':
              // Catalog acts as "Our Services / Packages"
        ...
        <section className="section-padding text-center" style={{ backgroundColor: '#ffffff' }}>
          <div className="container">
            <div className="section-header">
              ...
              <p>Inquire about pricing, custom services, or schedule a consultation call.</p>
            </div>
